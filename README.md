...
Настроить работу любого проекта на сервере.

### Решение:

1. https://myappleshoptest.sytes.net/ - развернут на VDS, скриншот подтверждения подлинности приложил:

   ![1](1.JPG)

2. https://rooomario777.pythonanywhere.com/ - развернут согласно методическим данным к лекции.